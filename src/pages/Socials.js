  ...
  return (
    <div id="socials" className="">
      ...
      <Parallax speed={50}>
        ...
        <a href="" className="flex md:flex-col justify-center items-center hover:text-green-600">
            <svg
          ...
          <a href="https://github.com/EliaRitzmann" className="flex md:flex-col justify-center items-center hover:text-teal-400">
          <svg
            xmlns="http://www.w3.org/2000/svg"

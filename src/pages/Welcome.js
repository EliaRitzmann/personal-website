...
export const Welcome = () => {
  return (
    ...
    >
      <div className="absolute top-6 right-20 text-xl font-semibold dark:text-purple-600 text-black">
        {"Toggle Color ->"}
      </div>
      <div className="flex justify-center flex-col">
        <h1 className="text-6xl text-center dark:text-orange-500 mb-4">
          Elia Ritzmann
        </h1>

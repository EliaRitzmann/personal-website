  ...
  return (
    <div id="skills" className=" bg-black dark:bg-[#FF81B2]">
      ...
      <div className="hidden md:block">
        <div className="flex gap-4 flex-row-reverse mr-12 mb-4">
          <Parallax
            ...
            speed={10}
          >
            <img src={cs} alt="C# Logo" className="w-10 h-10"></img>
        ...
        <div className="flex gap-4 flex-row-reverse mr-12">
          ...
          <Parallax
            ...
            speed={50}
          >
            <img src={databse} alt="Database Logo" className="w-10 h-10"></img>
          ...
          <Parallax
            ...
            speed={20}
          >
            <img src={react} alt="React native Logo" className="w-10 h-10"></img>
          ...
          <Parallax
            ...
            speed={50}
          >
            <img src={javascript} alt="JavaScript Logo" className="w-10 h-10"></img>
      ...
      <div className="md:hidden flex flex-col items-center gap-7 mt-4">
        ...
        <div className="flex gap-1 p-2 bg-white w-1/2 rounded-md justify-center mr-20">
        <img src={javascript} alt="JavaScript Logo" className="w-8 h-8"></img>
            <h1 className="text-lg font-bold">Javascript</h1>
        </div>
        <div className="flex gap-1 p-2 bg-white w-1/2 rounded-md justify-center ml-20">
        <img src={databse} alt="Database Logo" className="w-8 h-8"></img>
            <h1 className="text-lg font-bold">SQL</h1>
        </div>
        <div className="flex gap-1 p-2 bg-white w-1/2 rounded-md justify-center mr-20">
        <img src={cs} alt="C# Logo" className="w-8 h-8"></img>
            <h1 className="text-lg font-bold">.Net</h1>
        </div>
      </div>
    </div>
